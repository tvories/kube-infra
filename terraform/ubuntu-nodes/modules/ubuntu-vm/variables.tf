...
variable "dns_domain" {
  description = "The DNS domain for the virtual machines."
  type = string
  default = ""
}
...
variable "tag_ubuntu_k8_env" {
  description = "The tag for the ubuntu K8 environment IE: ubuntu_k8_prod or ubuntu_k8_staging"
  type = string
  default = ""
}
...
variable "k8_minion_tag" {
  description = "the tag for k8 minions with environment"
  type = string
}
variable "k8_master_tag" {
  description = "the tag for k8 masters with env"
  type = string
}